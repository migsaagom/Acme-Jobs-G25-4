...
<acme:list>
	...
	<!--<acme:list-column code="worker.application.list.label.worker" path="worker" width="20%"/>
	<acme:list-column code="worker.application.list.label.job" path="job" width="20%"/>-->
</acme:list>